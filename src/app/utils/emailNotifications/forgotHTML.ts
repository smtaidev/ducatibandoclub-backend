...
<head>
    ...
    <title>Al-Sultan Forgot Password Verification</title>
    <style>
                    ...
                    <div class="email-content">
                        ...
                        <p class="main-text">
                            We received a request to reset the password for your account on <span
                                class="brand-highlight">Al-Sultan</span>. Use this OTP to complete the password reset
                            process.
                        </p>

                        <p class="warning-text">
                            Remember, Never share this OTP with anyone, not even if <span
                                class="brand-highlight">Al-Sultan</span> asks you.
                        </p>
